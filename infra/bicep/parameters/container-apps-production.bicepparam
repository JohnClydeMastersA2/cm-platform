...
param databaseUrl = readEnvironmentVariable('POSTGRES_DATABASE_URL')
...
param healthcareTransformMongoDbUri = readEnvironmentVariable('HEALTHCARE_TRANSFORM_MONGODB_URI')
...
param healthcareTransformMongoDbDatabase = 'healthcare_transform'
...
param demoMaintenanceCronExpression = '0 14 * * *'
param costReportingEnabled = true
param costReportingRetentionDays = 60
